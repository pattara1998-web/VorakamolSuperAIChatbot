...
const FOLLOWUP_TEMPLATES = [
  {
    ...
    badge: 'กระตุ้นยอดขาย',
    message: '💥 โปรโมชั่น Flash Sale พิเศษเฉพาะรอบวันนี้! สั่งซื้อตอนนี้รับส่วนลดทันที พร้อมของสมนาคุณพิเศษและจัดส่งฟรีเก็บเงินปลายทาง แจ้งชื่อ-ที่อยู่เพื่อรับสิทธิ์ได้เลยนะคะ ⚡'
  },
  {
