...
export const ProductTemplateModal: React.FC<ProductTemplateModalProps> = ({
  ...
  const [formData, setFormData] = useState<any>({
    ...
    price_2: 1800,
    price_3: 2500,
    promotion_detail: 'ซื้อ 2 ชิ้น ส่งฟรีเก็บเงินปลายทาง แถมของขวัญพิเศษ',
    shipping_duration: 'จัดส่งด่วน 1-2 วันทำการ (Flash / Kerry)',
    image_main: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?auto=format&fit=crop&w=800&q=80',
    image_detail: 'https://images.unsplash.com/photo-1584992236310-6edddc08acff?auto=format&fit=crop&w=800&q=80',
    image_promotion: 'https://images.unsplash.com/photo-1607083206869-4c7672e72a8a?auto=format&fit=crop&w=800&q=80',
    image_review: 'https://images.unsplash.com/photo-1556740738-b6a63e27c4df?auto=format&fit=crop&w=800&q=80',
    image_closing: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=800&q=80',
    opening_text: 'สวัสดีค่ะ สนใจรับโปรโมชั่นพิเศษ สอบถามแอดมินได้เลยนะคะ 🙏',
    detail_text: 'สินค้าคุณภาพดี การันตีของแท้ 100% พร้อมบริการเก็บเงินปลายทางค่ะ',
    promotion_text: 'โปรโมชั่นพิเศษวันนี้ สั่งซื้อ 2 ชิ้น ประหยัดทันที จัดส่งฟรีถึงหน้าบ้านค่ะ',
    review_text: '⭐⭐⭐⭐⭐ ลูกค้าประทับใจ การันตีรีวิวจากผู้ใช้งานจริงทั่วประเทศ',
    closing_text: 'แจ้งชื่อ-ที่อยู่ และเบอร์โทรศัพท์เพื่อรับสิทธิ์ส่งฟรีเก็บเงินปลายทางได้เลยนะคะ',
    // Specific defaults
    brand: '',
    description: '',
    features: '',
    ...
    usage: '',
    benefit: '',
    shipping_info: 'จัดส่งด่วน 1-2 วัน มีบริการเก็บเงินปลายทาง (COD)',
    temple: '',
    master: '',
    year: '',
    edition: '',
