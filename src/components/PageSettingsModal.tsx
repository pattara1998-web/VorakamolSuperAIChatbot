              ...
              <div className="bg-white dark:bg-[#121216] border border-slate-200 dark:border-zinc-800 rounded-xl p-5 space-y-4 shadow-xs">
                ...
                <div className={`p-3 rounded-lg border ${
                  ...
                  <span className={`text-xs font-medium ${
                    ...
                    {formData.sales_sequence_auto_trigger
                      ? '🚀 เปิดใช้งาน - ระบบจะส่ง Sales Sequence ทั้งหมดทันทีเมื่อลูกค้าทักครั้งแรกหรือพูดว่า "สนใจ" (พรีเซน 1 ครั้ง / 24 ชม. / ลูกค้า)'
                      : '⏸️ ปิดใช้งาน - AI เป็นผู้ตอบลูกค้าเองทุกจุด (Sales Sequence จะส่งเฉพาะเมื่อลูกค้าพูดคีย์เวิร์ดสนใจซื้อชัดเจน เช่น "สนใจ" ครั้งแรกเท่านั้น — AI ไม่ส่งสเต็ปตามหลัง)'}
                  </span>
                </div>
